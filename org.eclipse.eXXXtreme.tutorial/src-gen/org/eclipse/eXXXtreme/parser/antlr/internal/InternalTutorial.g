...
(	otherlv_0='DBName' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getModelAccess().getDBNameKeyword_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getModelAccess().getNameValidIDParserRuleCall_1_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_2, grammarAccess.getModelAccess().getH2FileKeyword_2());
    }
(
(
		lv_h2Path_3_0=RULE_STRING
		{
			newLeafNode(lv_h2Path_3_0, grammarAccess.getModelAccess().getH2PathSTRINGTerminalRuleCall_3_0()); 
		}
		{
	        if ($current==null) {
