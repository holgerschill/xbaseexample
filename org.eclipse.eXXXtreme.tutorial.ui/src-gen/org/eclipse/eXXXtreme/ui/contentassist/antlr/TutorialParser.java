 ...
 * generated by Xtext
 */
package org.eclipse.eXXXtreme.ui.contentassist.antlr;
...
public class TutorialParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.eclipse.eXXXtreme.ui.contentassist.antlr.internal.InternalTutorialParser createParser() {
		org.eclipse.eXXXtreme.ui.contentassist.antlr.internal.InternalTutorialParser result = new org.eclipse.eXXXtreme.ui.contentassist.antlr.internal.InternalTutorialParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getModelAccess().getH2PathAssignment_3(), "rule__Model__H2PathAssignment_3");
					put(grammarAccess.getModelAccess().getQueriesAssignment_4(), "rule__Model__QueriesAssignment_4");
					put(grammarAccess.getQueryAccess().getNameAssignment_1(), "rule__Query__NameAssignment_1");
					put(grammarAccess.getQueryAccess().getTableAssignment_2(), "rule__Query__TableAssignment_2");
					put(grammarAccess.getQueryAccess().getExpressionAssignment_3(), "rule__Query__ExpressionAssignment_3");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.eclipse.eXXXtreme.ui.contentassist.antlr.internal.InternalTutorialParser typedParser = (org.eclipse.eXXXtreme.ui.contentassist.antlr.internal.InternalTutorialParser) parser;
